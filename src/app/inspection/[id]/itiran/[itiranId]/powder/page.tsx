...
import PowderBekki8Form from "@/components/powder-bekki8-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "powder"

export default async function PowderBekki8Page({
    params,
}: {
