...
import OkugaiShokasenBekki9Form from "@/components/okugai-shokasen-bekki9-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "okugai-shokasen"

export default async function OkugaiShokasenBekki9Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_okugai_shokasen_bekki9")
