...
import InertGasBekki6Form from "@/components/inert-gas-bekki6-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "inert-gas"

export default async function InertGasBekki6Page({
    params,
}: {
