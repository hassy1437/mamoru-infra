...
/**
 * ★4 で出ることが分かっている様式（＝いま○が一度も描かれていない選択肢欄）。
 *
...
const KNOWN_UNEXERCISED = [
    "bekki11_1_test", "bekki20_test", "bekki2_test", "bekki3_test", "bekki4_test",
    "bekki5_test", "bekki6_test", "bekki7_test", "bekki8_test", "bekki9_test",
]
