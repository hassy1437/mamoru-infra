...
const PERIOD_START_ANCHORS = { year: 299.2, month: 330.6, day: 362.2, baseline: 180.36 }
const PERIOD_END_ANCHORS = { year: 414.7, month: 446.4, day: 477.9, baseline: 180.36 }
...
export async function POST(req: NextRequest) {
    try {
        ...
        drawInCell(page1, p1Height, body.inspector_name, 144.4, 187.44, 61.64, 56.4, 8.8)
        ...
        if (systemOverflow.length) {
            ...
            console.error("[pdf] 収容不能(システム由来)", { form: "別記様式第1", items: systemOverflow })
        }
        const fitFormLabel = "別記様式第1"
        ...
        const fitError = buildFitError("別記様式第1", fonts.fit!)
