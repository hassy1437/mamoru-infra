...
import ConnectedSprinklerBekki19Form from "@/components/connected-sprinkler-bekki19-form"
import {
...
export default async function ConnectedSprinklerBekki19Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_connected_sprinkler_bekki19")
