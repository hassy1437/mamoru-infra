...
import StandpipeBekki20Form from "@/components/standpipe-bekki20-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "standpipe"

export default async function StandpipeBekki20Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_standpipe_bekki20")
