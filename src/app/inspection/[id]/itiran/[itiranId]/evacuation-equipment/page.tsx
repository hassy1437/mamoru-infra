...
import EvacuationEquipmentBekki15Form from "@/components/evacuation-equipment-bekki15-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "evacuation-equipment"

export default async function EvacuationEquipmentBekki15Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_evacuation_equipment_bekki15")
    ...
    return (
        <main className="min-h-screen bg-gray-100 py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <EvacuationEquipmentBekki15Form
                    initial={{
