...
import GuidanceLightsSignsBekki16Form from "@/components/guidance-lights-signs-bekki16-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "guidance-lights-signs"

export default async function GuidanceLightsSignsBekki16Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_guidance_lights_signs_bekki16")
    ...
    return (
        <main className="min-h-screen bg-gray-100 py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <GuidanceLightsSignsBekki16Form
                    initial={{
