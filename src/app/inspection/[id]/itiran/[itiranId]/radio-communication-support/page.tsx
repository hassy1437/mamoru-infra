...
import RadioCommunicationSupportBekki22Form from "@/components/radio-communication-support-bekki22-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "radio-communication-support"

export default async function RadioCommunicationSupportBekki22Page({
    params,
}: {
    ...
    const backLabel = prevStep ? getItiranInputBackLabel(prevStep) : "????????"
    ...
    const { data: saved } = await supabase
        .from("inspection_radio_communication_support_bekki22")
    ...
    return (
        <main className="min-h-screen bg-gray-100 py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <RadioCommunicationSupportBekki22Form
                    initial={{
