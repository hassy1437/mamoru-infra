...
import FireWaterBekki17Form from "@/components/fire-water-bekki17-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "fire-water"

export default async function FireWaterBekki17Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_fire_water_bekki17")
