...
import HalogenBekki7Form from "@/components/halogen-bekki7-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "halogen"

export default async function HalogenBekki7Page({
    params,
}: {
