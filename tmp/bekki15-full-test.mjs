...
const payload = {
    ...
    page1_rows: [
        ...
        { content: "操作面積1.5m²以上確保", judgment: "良" },                 // 1 周囲の状況：操作面積等
        { content: "開口部 0.5m×1.0m 確保", judgment: "良" },                // 2 周囲の状況：開口部
        { content: "降下空間 障害物なし", judgment: "良" },                   // 3 周囲の状況：降下空間
        { content: "避難空地 十分確保", judgment: "良" },                     // 4 周囲の状況：避難空地
        { content: "標識 明瞭", judgment: "良" },                            // 5 標識
        { content: "変形・腐食なし", judgment: "良" },                        // 6 縦棒
        { content: "変形・破損なし", judgment: "良" },                        // 7 横さん
        ...
        { content: "降下速度 規定値内", judgment: "良" },                      // 14 調速機機能
    ...
    page2_rows: [
        ...
        { content: "接合部 緩みなし", judgment: "良" },                       // 5 接合部（避難用タラップ）
        { content: "外形 腐食なし", judgment: "良" },                         // 6 可動部外形（避難用タラップ）
        { content: "昇降動作 正常", judgment: "良" },                         // 7 機能（避難用タラップ）
        { content: "本体布 破れ・劣化なし", judgment: "良" },                  // 8 本体布及び展張部材
        { content: "縫い合せ部 異常なし", judgment: "良" },                    // 9 縫い合せ部
    ...
    notes: "令和8年2月度定期点検実施。全避難器具について機器点検及び総合点検を実施した。避難はしご（3階東側）の横さんに軽微な塗装剥離を確認したが、強度に問題なし。次回点検は令和8年8月予定。",
...
const outPath = path.resolve("tmp/bekki15_full_test2.pdf");
console.log("Generating bekki15 full test PDF...");
