...
import GasLeakFireAlarmBekki11_2Form from "@/components/gas-leak-fire-alarm-bekki11-2-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "gas-leak-fire-alarm"

export default async function GasLeakFireAlarmBekki11_2Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_gas_leak_fire_alarm_bekki11_2")
