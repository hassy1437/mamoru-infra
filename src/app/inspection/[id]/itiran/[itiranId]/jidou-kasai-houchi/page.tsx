...
import JidouKasaiHouchiBekki11_1Form from "@/components/jidou-kasai-houchi-bekki11-1-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "jidou-kasai-houchi"

export default async function JidouKasaiHouchiBekki11_1Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_jidou_kasai_houchi_bekki11_1")
