...
const PERIOD_START_ANCHORS: DateAnchors = { year: 311.88, month: 343.45, day: 374.9, baseline: 178.2 }
const PERIOD_END_ANCHORS: DateAnchors = { year: 427.46, month: 459.03, day: 490.47, baseline: 178.2 }
...
export async function POST(req: NextRequest) {
    try {
        ...
        drawResultRows(page1, p1Height, body.page1_rows ?? [], P1_ROW_BOUNDS, {
            ...
            2: { x: 221.16, w: 97.32 },   // 刷り込み「Ｖ」(318.48) の手前で止める
            12: { x: 221.16, w: 97.32 },   // 刷り込み「Ｖ」(318.48) の手前で止める
            14: { x: 221.16, w: 97.32 },   // 刷り込み「Ａ」(318.48) の手前で止める
        ...
        drawResultRows(page2, p2Height, body.page2_rows ?? [], P2_ROW_BOUNDS, {
            ...
            8: { x: 221.16, w: 90.24 },   // 刷り込み「Ｖ」(311.40) の手前で止める
            11: { x: 221.16, w: 90.24 },   // 刷り込み「Ａ」(311.40) の手前で止める
        ...
        const fitError = buildFitError("別記様式第14", fonts.fit!)
