...
const SHB = {
  issue_year: 181,   // 年ラベル左端 181.6
  issue_month: 205,  // 月ラベル左端 205.6
  issue_day: 229,    // 日ラベル左端 229.6
  license:  { x: 244, w: 64 },   // 交付番号 x=244-308 (垂直線: x=308)
  governor: { x: 308, w: 49 },   // 交付知事 x=308-357 (垂直線: x=357)
  tr_year: 394, tr_month: 418,   // 年ラベル左端 394.4, 月ラベル左端 418.4
};
...
// 水平線: 303-304(列ヘッダ行下端), 319(特種), 333.5(第1種), 348(第2種)
// ※304.5は「種類等/交付年月日」の列ヘッダー行 → データは319から開始
const KSA = {
  issue_year: 182, issue_month: 206, issue_day: 230,  // 年182.2, 月206.2, 日230.2
  license: { x: 241, w: 98 },   // 交付番号 x=241-339 (垂直線: x=241, 339)
  exp_year: 376, exp_month: 400, exp_day: 424,        // 年376.4, 月400.4, 日424.4
};
