...
import WaterSprayBekki4Form from "@/components/water-spray-bekki4-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "water-spray"

export default async function WaterSprayBekki4Page({
    params,
}: {
