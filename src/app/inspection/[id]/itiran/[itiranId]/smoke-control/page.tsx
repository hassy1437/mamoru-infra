...
import SmokeControlBekki18Form from "@/components/smoke-control-bekki18-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "smoke-control"

export default async function SmokeControlBekki18Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_smoke_control_bekki18")
