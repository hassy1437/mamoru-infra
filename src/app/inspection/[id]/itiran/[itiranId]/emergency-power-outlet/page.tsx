...
import EmergencyPowerOutletBekki21Form from "@/components/emergency-power-outlet-bekki21-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "emergency-power-outlet"

export default async function EmergencyPowerOutletBekki21Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_emergency_power_outlet_bekki21")
    ...
    return (
        <main className="min-h-screen bg-gray-100 py-8">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <EmergencyPowerOutletBekki21Form
                    initial={{
