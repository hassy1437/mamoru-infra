...
import ShokasenBekki2Form from "@/components/shokasen-bekki2-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "shokasen"

export default async function ShokasenBekki2Page({
    params,
}: {
