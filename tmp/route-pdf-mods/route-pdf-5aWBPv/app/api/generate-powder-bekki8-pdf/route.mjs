...
import { drawWrappedTextInCell, formatJapaneseDateText } from "file:///C:/projects/fire-report-app/tmp/route-pdf-mods/route-pdf-5aWBPv/lib/pdf-form-helpers.mjs";
const P1_ROW_BOUNDS = [
...
export async function POST(req) {
    try {
        ...
        const drawWrappedInCell = (page, pageHeight, text, cellX, cellTopFromTop, cellW, cellH, fontSize = 7.0) => drawWrappedTextInCell({
            page,
            pageHeight,
            font: customFont,
            text,
