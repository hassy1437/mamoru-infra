...
import EmergencyAlarmBekki14Form from "@/components/emergency-alarm-bekki14-form"
import {
...
const CURRENT_STEP_ID: ItiranInputStepId = "emergency-alarm"

export default async function EmergencyAlarmBekki14Page({
    params,
}: {
    ...
    const { data: saved } = await supabase
        .from("inspection_emergency_alarm_bekki14")
